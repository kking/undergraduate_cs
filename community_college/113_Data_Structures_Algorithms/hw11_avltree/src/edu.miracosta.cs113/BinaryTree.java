 ...
 * @author Data Structures: Abstraction and Design Using Java (2nd ed.), pp. 308
 */
public class BinaryTree<E> implements Serializable {
    ...
    private void preOrderTraverse(Node<E> node, int depth, StringBuilder sb) {
        ...
        if (node == null) {
            ...
            preOrderTraverse(node.left, depth + 1, sb); // Traverse left
            preOrderTraverse(node.right, depth + 1, sb); // Traverse right
        }
    }
